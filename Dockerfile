...
ARG GOOGLE_WORKSHEET_TITLE_CASHLESS

ARG PRIVAT24_API_ID
ARG PRIVAT24_API_TOKEN
ARG PRIVAT24_ACCOUNTS
ARG PRIVAT24_POLLING_INTERVAL
ARG PRIVAT24_GOOD_NAME_DEFAULT
...
ENV GOOGLE_WORKSHEET_TITLE_CASHLESS=$GOOGLE_WORKSHEET_TITLE_CASHLESS

ENV PRIVAT24_API_ID=$PRIVAT24_API_ID
ENV PRIVAT24_API_TOKEN=$PRIVAT24_API_TOKEN
ENV PRIVAT24_ACCOUNTS=$PRIVAT24_ACCOUNTS
ENV PRIVAT24_POLLING_INTERVAL=$PRIVAT24_POLLING_INTERVAL
ENV PRIVAT24_GOOD_NAME_DEFAULT=$PRIVAT24_GOOD_NAME_DEFAULT
